...
export const DEFAULT_HOME_CONTENT: HomeContent = {
    ...
    portfolio: {
        ...
        lead: "RAVOK builds at four layers of the entertainment stack — film as a standalone company, fintech for transparent profit participation, AI for audience validation, and creator-first distribution. Each one closes a gap the old system left open.",
        ...
        steps: [
            {
                tag: "Pillar · 01",
                name: "Film",
                title: "Each project, a **standalone company**.",
                body:
            ...
            },
            {
                tag: "Pillar · 03",
                name: "AI",
                title: "Audience signal **before a single frame is shot**.",
                body: "Validation, project management, and a Co-Pilot for the entertainment teams that build with us. Tested before greenlight, not after.",
                meta: [
            ...
            },
            {
                tag: "Pillar · 04",
                name: "Distribution",
                title: "Direct to audience, **without giving up ownership**.",
                body: "Creator-first streaming on the project's own terms. The SPV controls its own exit — distribution is one of the doors, not the only one.",
                meta: [
