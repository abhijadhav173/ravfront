...
export const DEFAULT_HOME_CONTENT: HomeContent = {
    sectionOrder: ["intro", "bridge", "portfolio", "signal", "window"],
    hero: {
    ...
    portfolio: {
        eraLabel: "Submissions open soon",
        eraEyebrow: "What we back",
        headline: "Four ways we build with creators.",
        lead: "RAVOK is structured around four pillars — each one a piece of the infrastructure that lets a film operate like a real company. Films incorporate as SPVs. Profit participation runs through Meris. Audience validation runs through Delphi. Distribution runs through Phema.",
        ctaLabel: "Submissions open soon →",
        ctaHref: "/contact-us",
        label: "What we back",
        counterSuffix: "WHAT WE BACK",
        steps: [
            {
            ...
            },
            {
                ...
                body:
                    "Carta meets Robinhood for film. Cap table management, profit participation tracking, and real-time distribution to every position on the waterfall — from above-the-line to grip.",
                meta: [
                    "Core product built",
                    "Beta live · merisbeta.com",
                    "First SPV onboarded",
                ],
                chip: "Card + SaaS",
                badgeNum: "02",
            ...
            },
            {
                ...
                name: "Delphi",
                title: "Audience validation, **before** a single frame is shot.",
                body: "AI-powered audience research and project management for entertainment teams. The full Co-Pilot for film development.",
                meta: [
                    "AI audience validation engine",
            ...
            },
            {
                ...
                name: "Phema",
                title: "Creator-first **AVOD streaming**.",
                body: "Distribution that doesn't take ownership of the work. The SPV controls its own exit — Phema is one of the doors.",
                meta: [
    ...
    window: {
        ...
        lead: "Occasional updates from the studio. New writing, new milestones, when submissions open.",
    ...
    signal: {
        ...
        headline: "What we're writing about.",
        body: "Operating principles, packaging lessons, audience patterns. Notes from inside the studio — published as we figure them out.",
        ctas: [
            { label: "Read the latest →", href: "/insights", variant: "primary" },
            { label: "All posts →", href: "/insights", variant: "secondary" },
        ],
    },
