...
export const DEFAULT_HOME_CONTENT: HomeContent = {
    ...
    hero: {
        tagline: "Films built like worlds.\nWorlds built to **last**.",
        logoImage: "/images/logo.png",
        templeImage: "/images/bg_image.png",
        scrollCue: "↓ Era Zero is forming",
    },

    intro: {
        eyebrow: "— Why we exist",
        headline: "The system we inherited was built to **extract**.\nWe're building one that's built to **last**.",
        body1:
        ...
        ctas: [
            { label: "Enter the worlds →", href: "#portfolio", variant: "primary" },
            { label: "Read the thesis →", href: "/our-model", variant: "secondary" },
            { label: "Join the signal →", href: "#window", variant: "secondary" },
        ],
    ...
    portfolio: {
        eraLabel: "Era Zero",
        eraEyebrow: "Forming now",
        headline: "Two films incorporated.\n**Twenty more on the way.**",
        lead: "A symbol for each one, when the time is right. We're not announcing them yet — the people on the list will know first. Era Zero is the founding cycle. These are the four worlds opening it.",
        ctaLabel: "Join the signal →",
        ctaHref: "#window",
        label: "The Worlds",
        counterSuffix: "THE WORLDS",
        steps: [
            {
                tag: "World · 01",
                name: "World 01",
                title: "*Symbol forthcoming.*",
                body:
                    "A story about ambition, inheritance, and the cost of being seen. Emmy-nominated director attached. Currently raising production financing.",
                meta: [
                    "**Emmy-nominated** director attached",
                    "Tax rebate secured",
                    "Distribution conversations underway",
            ...
            },
            {
                ...
                title: "*Symbol forthcoming.*",
                body:
                    "Genre, cast, and creator team confirmed — the title stays under wraps until the symbol drops. PGA-credited producer attached. Incorporated as its own company.",
                meta: [
                    "**PGA producer** on board",
                    "SPV spun out · cap table clean",
                    "Crew equity allocated",
                ],
                chip: "In development",
                badgeNum: "02",
                badgeLabel: "World 02",
            ...
            },
            {
                tag: "World · 03",
                name: "World 03",
                title: "Era Zero continues.",
                body: "More worlds in early development. Symbols arrive when they're ready.",
                meta: [],
                chip: "Forthcoming",
                badgeNum: "03",
                badgeLabel: "World 03",
            ...
            },
            {
                ...
                name: "Era One",
                title: "Opens later.",
                body: "Era Zero closes when the founding slate is delivered. Era One opens with the next cycle of worlds — and a different shape entirely.",
                meta: [],
                chip: "Era One",
                badgeNum: "04",
                badgeLabel: "Era One",
    ...
    window: {
        eyebrow: "— The Signal",
        headline: "Join the people inside the work.",
        lead: "First to know when a symbol drops. First to RSVP to a screening. First to read the Dispatch. **The list sees everything before the public does — by 24 to 48 hours, every time.**",
        emailPlaceholder: "your@email.com",
        emailCta: "Get on the list",
    },

    signal: {
        eyebrow: "— From the Founder",
        headline: "What if we funded creators the way **VCs fund founders**?",
        body: '"What if films were structured like startups — with equity, governance, and long-term thinking? I was never very good at being digestible. That\'s exactly why I had to forge my own path."  — Amanda Aoki Rak, Founder',
        ctas: [
            { label: "Read more from Amanda →", href: "/about-us", variant: "primary" },
            { label: "Read the thesis →", href: "/our-model", variant: "secondary" },
            { label: "Talk to us →", href: "/contact-us", variant: "secondary" },
        ],
    },
