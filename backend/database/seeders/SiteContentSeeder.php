...
/**
 * Seeds the site_content table with the homepage content matching the
 * current website-q2 design 1:1.
 *
 * Convention: text fields use `**word**` to mark gold-italic emphasis.
 * Frontend `renderInline()` wraps those into <em> at render time, so admin
 * editors only ever type plain text + `**phrase**` markers.
 */
    ...
    private function homeContent(): array
    {
        return [
            ...
            'intro' => [
                ...
                'body1' => 'The legal and accounting infrastructure that makes a tech startup underwritable — cap tables, audit trails, verifiable performance — was never built for film. **So we\'re building it.**',
                'body2' => 'RAVOK is a venture studio for entertainment. Each project incorporates as its own company, with creator equity, transparent waterfalls, and audit-grade reporting. The same structural rigor every other industry takes for granted — finally applied to a $2.9T market that still runs on handshake deals.',
                'facts' => [
            ...
            'bridge' => [
                ...
                'lead' => 'Before REITs, real estate was illiquid, opaque, relationship-driven. A legal structure and a disclosure regime turned it into a **$4T asset class**. Same pattern. Different industry.',
