...
import { getStoredUser, getCategories, createCategory, createPost, uploadPostImage, getPostImageUrl, type Category } from "@/lib/api";
import { toast } from "@/lib/toast";
import { ChevronLeft, Plus, X } from "lucide-react";
import { RichTextEditor } from "@/components/RichTextEditor";

export default function AdminPostsAddPage() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <p className="text-sm text-ravok-slate font-sans mb-6">Create a new post (publish date = created at)</p>

      <Card className="bg-white/5 border-white/10">
        <CardHeader>
          <CardTitle className="text-lg font-heading text-ravok-gold">New post</CardTitle>
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <Button
                  ...
                  variant="outline"
                  size="xs"
                  className="border-ravok-gold/50 text-ravok-gold hover:bg-ravok-gold/10 text-xs"
